          ...
          ...posts.map((p) => Card(
            ...
            child: ListTile(
              ...
              trailing: Column(
                ...
                children: const [Icon(Icons.more_horiz, size: 20)],
              ),
            ),
          )),
        ],
...
class _GoalsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12), side: BorderSide(color: Colors.black.withOpacity(0.8), width: 2)),
      child: Padding(
